...
class WarmFiberSectorSnapshot extends Command
{
    /*
    |--------------------------------------------------------------------------
    | Command Signature
    ...
    */
    ...
    protected $signature =
        'digestex:fiber-sector-snapshot';
    ...
    */
    ...
    protected $description =
        'Build and cache the Digestex Fiber Trade Intelligence snapshot.';
    ...
    */
    ...
    public function handle(
        FiberTradeIntelligenceService $service,
        TradeReportingPeriodProvider $periodProvider
    ): int {
        $this->info(
            'Building Fiber Trade Intelligence snapshot...'
        );
        ...
        try {
            ...
            */
            ...
            $this->error(
                'Failed to generate Fiber snapshot.'
            );
