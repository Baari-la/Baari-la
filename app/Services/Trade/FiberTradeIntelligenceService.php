...
class FiberTradeIntelligenceService
{
    /*
    |--------------------------------------------------------------------------
    | Snapshot / Cache
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | PUBLIC: Get Current Fiber Intelligence
    |--------------------------------------------------------------------------
    */
                    ...
                    function ($row) {
                        ...
                        return [
                            ...
                            'subsector' =>
                                ...
                                'parent_subsector' =>
                                    $classification['parent_subsector']
                                        ?? null,
                            'label_en' =>
        ...
        */
        ...
        return [
            ...
            */
            ...
            |
            | Important:
            | This does NOT classify countries as "US Cotton"
            | or "Australian Cotton". It simply exposes the actual
            | country_name from the trade database.
            |
            | Later we can create dedicated Cotton Origin Analysis
            | using the same trusted origin data.
            |
            */

            'cotton_origin_intelligence' =>
                $this->buildCottonOriginIntelligence(
                    $current
                ),
        ];
    }
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Only Cotton subsector is included here.
    |
    | This uses the actual country_name in trade_statistics.
    | It does not infer supplier nationality from company names.
    |--------------------------------------------------------------------------
    */

    protected function buildCottonOriginIntelligence(
        $rows,
        int $limit = 20
    ): array {
        $cotton =
