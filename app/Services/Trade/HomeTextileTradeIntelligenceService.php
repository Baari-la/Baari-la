...
class HomeTextileTradeIntelligenceService
{
    /*
    |--------------------------------------------------------------------------
    | Snapshot / Cache
    ...
    */
    ...
    public const CACHE_KEY =
        'digestex.trade.sector.home_textile';
    ...
    | 6302 = Linen / Bedding
    | 6303 = Curtains
    | 6304 = Other Home Textile
    |
    */

    protected const HOME_TEXTILE_HS4 = [
        '6301',
        '6302',
        '6303',
        '6304',
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | PUBLIC: Get Current Home Textile Intelligence
    |--------------------------------------------------------------------------
    */
            ...
            $rows
                ->map(
                    function ($row) {
                        ...
                        /*
                        |--------------------------------------------------------------------------
                        | Only actual Home Textile classification
                        |--------------------------------------------------------------------------
                        */
