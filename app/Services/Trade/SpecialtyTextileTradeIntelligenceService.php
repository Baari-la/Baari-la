...
class SpecialtyTextileTradeIntelligenceService
{
    /*
    |--------------------------------------------------------------------------
    | Snapshot / Cache
    ...
    */
    ...
    public const CACHE_KEY =
        'digestex.trade.sector.specialty_textile';
    ...
    /*
    |--------------------------------------------------------------------------
    | Confirmed Specialty Textile HS4
    |--------------------------------------------------------------------------
    |
    | Verified against TextileTaxonomyService
    |
    | 5801 = Pile / Chenille Fabric
    | 5701-5705 = Floor Covering / Carpet
    |
    */

    protected const SPECIALTY_TEXTILE_HS4 = [
        '5801',
        '5701',
        '5702',
        '5703',
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | PUBLIC: Get Current Specialty Textile Intelligence
    |--------------------------------------------------------------------------
    */
    ...
    */
    ...
    protected function buildSnapshot(
        ...
        */
        ...
        |
        | Current:
        | January → Admin public-through month
        |
        | Comparison:
        | January → comparison public-through month
        |
        */
            ...
            $rows
                ->map(
                    function ($row) {
                        ...
                        /*
                        |--------------------------------------------------------------------------
                        | Only actual Specialty Textile classification
                        |--------------------------------------------------------------------------
                        */
