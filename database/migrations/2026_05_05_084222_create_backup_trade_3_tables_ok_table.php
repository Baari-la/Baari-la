...
return new class extends Migration
{
    ...
    {
        if (!Schema::hasTable('backup_trade_3_tables_ok')) {

            Schema::create('backup_trade_3_tables_ok', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('backup_trade_3_tables_ok');
    }
};