...
return new class extends Migration
{
    ...
    {
        if (!Schema::hasTable('bkp_stg_impor_hs_val_fix')) {
        Schema::create('bkp_stg_impor_hs_val_fix', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('bkp_stg_impor_hs_val_fix');
    }
};