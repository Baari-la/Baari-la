...
return new class extends Migration
{
    ...
    {
        if (!Schema::hasTable('trade_master_annual_hscode')) {
        Schema::create('trade_master_annual_hscode', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('trade_master_annual_hscode');
    }
};