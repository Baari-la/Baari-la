export default function ExecutivePerformanceTable({ data = [] }) {
    const formatPieces = (value) => `${(value / 1000000).toFixed(1)} M pcs`;
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
            <div className="px-6 py-5 border-b bg-gray-50">
                <h2 className="text-xl font-bold text-gray-900">
                    Executive Apparel Export Volume in Pieces
                </h2>

                <p className="text-sm text-gray-500 mt-1">
                    {/* Estimated pieces converted from official trade volume (KG)
                    using Digestex Apparel Conversion Engine */}
                </p>
            </div>
