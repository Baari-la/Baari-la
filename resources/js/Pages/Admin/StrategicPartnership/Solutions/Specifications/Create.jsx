...
export default function Create({ partner, solution }) {
    ...
    const submit = (e) => {
        ...
        post(
            route("admin.industry-partner-solution-specifications.store", {
                partner: partner.id,
    ...
    return (
        <>
            <Head title={`Add Specification — ${solution.title}`} />
