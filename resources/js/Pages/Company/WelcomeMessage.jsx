{
    /* HERO MESSAGE: THE FUTURE OF TEXTILE CONTROL */
}
<div className="mb-12 relative overflow-hidden rounded-[50px] bg-gradient-to-br from-[#0d1d36] to-[#0a192f] border border-blue-500/20 p-12 shadow-2xl">
    ...
    <div className="relative z-10">
        <div className="flex items-center gap-4 mb-8">
            ...
            <span className="text-gray-500 text-[8px] font-black uppercase tracking-[0.3em] italic">
