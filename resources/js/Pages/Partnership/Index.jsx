    ...
    return (
        ...
        >
            ...
            <div className="py-12 bg-[#0a192f] min-h-screen text-white">
                <div className="bg-white/5 backdrop-blur-md p-10 rounded-[50px] border border-white/10 hover:border-yellow-500/50 hover:bg-white/10 transition-all duration-500 group shadow-2xl">
                    {/* HERO SECTION */}
                    {/* 1. HERO SECTION */}
                    <div className="text-center space-y-6 py-10">
                        ...
                        <p className="text-gray-400 text-lg max-w-3xl mx-auto font-light leading-relaxed italic py-6">
                            {isEn
                        ...
                        {/* POSISI BARU: STATS BADGE (DI ANTARA HERO DAN GRID) */}
                        <div className="flex flex-wrap justify-center gap-8 md:gap-20 py-10 border-y border-white/5 bg-white/[0.02] rounded-[40px]">
                            <div className="text-center group">
                                <p className="text-yellow-500 text-4xl md:text-5xl font-black italic tracking-tighter group-hover:scale-110 transition-transform duration-500">
                                    1.9K+
                                </p>
                    ...
                    {/* Batas tambhn di bawah hero section */}
