...
export default function FabricIntelligence({ fabric = {}, page = {} }) {
    const { props } = usePage();
    ...
    */
    ...
    const overview = fabric?.overview ?? {
        import: {
            current: 0,
            previous: 0,
            growth_percent: 0,
    ...
    const bySubsector = fabric?.by_subsector ?? [];

    const topImportProducts = fabric?.top_import_products ?? [];

    const topExportProducts = fabric?.top_export_products ?? [];

    const topImportOrigins = fabric?.top_import_origins ?? [];

    const topExportDestinations = fabric?.top_export_destinations ?? [];

    const importMarketShare = fabric?.import_market_share ?? [];

    const exportMarketShare = fabric?.export_market_share ?? [];

    const monthlyTrend = fabric?.monthly_trend ?? [];

    const hs8Products = fabric?.hs8_products ?? [];
                ...
                <main className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
                    ...
                    <section className="mb-8">
                        <div className="mb-4">
                            ...
                            <p className="mt-1 text-sm text-slate-500">
                                {isEn
                                    ? "Current Fabric trade position and year-on-year movement."
                                    : "Posisi perdagangan Fabric saat ini dan pergerakan year-on-year."}
                            </p>
                        </div>
                        ...
                        <div className="mb-4 flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-slate-500">
                                    {isEn
                                        ? "Fabric market by product segment."
                                        : "Struktur pasar Fabric berdasarkan segmen produk."}
                                </p>
                            </div>
                        </div>
                    ...
                    <section className="mb-8">
                        <div className="mb-4">
                            ...
                            <p className="mt-1 text-sm text-slate-500">
                                {isEn
                                    ? "Key movements from the current Fabric trade snapshot."
                                    : "Pergerakan utama dari snapshot perdagangan Fabric saat ini."}
                            </p>
                        </div>
                        ...
                        <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-4">
                            ...
                            <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                                ...
                                <div className="mt-1 text-xs text-slate-400">
                                    {isEn
                                        ? "Largest Fabric import origin"
                                        : "Negara asal impor Fabric terbesar"}
                                </div>
                            </div>
                            ...
                            <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                                ...
                                <div className="mt-1 text-xs text-slate-400">
                                    {isEn
                                        ? "Largest Fabric export destination"
                                        : "Negara tujuan ekspor Fabric terbesar"}
                                </div>
                            </div>
                        </div>
                    </section>
                        ...
                        <div className="border-b border-slate-100 px-6 py-5">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-slate-500">
                                        {isEn
                                            ? "Detailed Fabric products by HS-8."
                                            : "Detail produk Fabric pada tingkat HS-8."}
                                    </p>
                                </div>
                            </div>
                        </div>
