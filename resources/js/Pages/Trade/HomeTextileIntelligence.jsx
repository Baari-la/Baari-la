...
export default function HomeTextileIntelligence({
    homeTextile = {},
    page = {},
}) {
    const { props } = usePage();
    ...
    */
    ...
    const overview = homeTextile?.overview ?? {
        import: {
            current: 0,
            previous: 0,
            growth_percent: 0,
    ...
    const bySubsector = homeTextile?.by_subsector ?? [];

    const topImportProducts = homeTextile?.top_import_products ?? [];

    const topExportProducts = homeTextile?.top_export_products ?? [];

    const topImportOrigins = homeTextile?.top_import_origins ?? [];

    const topExportDestinations = homeTextile?.top_export_destinations ?? [];

    const importMarketShare = homeTextile?.import_market_share ?? [];

    const exportMarketShare = homeTextile?.export_market_share ?? [];

    const monthlyTrend = homeTextile?.monthly_trend ?? [];

    const hs8Products = homeTextile?.hs8_products ?? [];
    ...
    */
    ...
    const labels = {
        title: "Home Textile Intelligence",

        subtitle: isEn
            ? "Home Textile Trade Intelligence"
            : "Trade Intelligence Tekstil Rumah Tangga",
                ...
                <main className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
                    ...
                    <section className="mb-8">
                        <div className="mb-4">
                            ...
                            <p className="mt-1 text-sm text-slate-500">
                                {isEn
                                    ? "Current Home Textile trade position and year-on-year movement."
                                    : "Posisi perdagangan Home Textile saat ini dan pergerakan year-on-year."}
                            </p>
                        </div>
                        ...
                        <div className="mb-4 flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-slate-500">
                                    {isEn
                                        ? "Home Textile market by product segment."
                                        : "Struktur pasar Home Textile berdasarkan segmen produk."}
                                </p>
                            </div>
                        </div>
                    ...
                    <section className="mb-8">
                        <div className="mb-4">
                            ...
                            <p className="mt-1 text-sm text-slate-500">
                                {isEn
                                    ? "Key movements from the current Home Textile trade snapshot."
                                    : "Pergerakan utama dari snapshot perdagangan Home Textile saat ini."}
                            </p>
                        </div>
                        ...
                        <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-4">
                            ...
                            <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                                ...
                                <div className="mt-1 text-xs text-slate-400">
                                    {isEn
                                        ? "Largest Home Textile import origin"
                                        : "Negara asal impor Home Textile terbesar"}
                                </div>
                            </div>
                            ...
                            <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                                ...
                                <div className="mt-1 text-xs text-slate-400">
                                    {isEn
                                        ? "Largest Home Textile export destination"
                                        : "Negara tujuan ekspor Home Textile terbesar"}
                                </div>
                            </div>
                        </div>
                    </section>
                        ...
                        <div className="border-b border-slate-100 px-6 py-5">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-slate-500">
                                        {isEn
                                            ? "Detailed Home Textile products by HS-8."
                                            : "Detail produk Home Textile pada tingkat HS-8."}
                                    </p>
                                </div>
                            </div>
                        </div>
