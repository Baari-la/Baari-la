...
export default function SpecialtyTextileIntelligence({
    specialtyTextile = {},
    page = {},
}) {
    const { props } = usePage();
    ...
    */
    ...
    const meta = specialtyTextile?.meta ?? {};
    ...
    const overview = specialtyTextile?.overview ?? {
        import: {
            current: 0,
            previous: 0,
            growth_percent: 0,
    ...
    const bySubsector = specialtyTextile?.by_subsector ?? [];

    const topImportProducts = specialtyTextile?.top_import_products ?? [];

    const topExportProducts = specialtyTextile?.top_export_products ?? [];

    const topImportOrigins = specialtyTextile?.top_import_origins ?? [];

    const topExportDestinations =
        specialtyTextile?.top_export_destinations ?? [];

    const importMarketShare = specialtyTextile?.import_market_share ?? [];

    const exportMarketShare = specialtyTextile?.export_market_share ?? [];

    const monthlyTrend = specialtyTextile?.monthly_trend ?? [];

    const hs8Products = specialtyTextile?.hs8_products ?? [];
    ...
    */
    ...
    const labels = {
        title: "Specialty Textile Intelligence",

        subtitle: isEn
            ? "Specialty Textile Trade Intelligence"
            : "Trade Intelligence Specialty Textile",
                ...
                <main className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
                    ...
                    <section className="mb-8">
                        <div className="mb-4">
                            ...
                            <p className="mt-1 text-sm text-slate-500">
                                {isEn
                                    ? "Current Specialty Textile trade position and year-on-year movement."
                                    : "Posisi perdagangan Specialty Textile saat ini dan pergerakan year-on-year."}
                            </p>
                        </div>
                        ...
                        <div className="mb-4 flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-slate-500">
                                    {isEn
                                        ? "Specialty Textile market by product segment."
                                        : "Struktur pasar Specialty Textile berdasarkan segmen produk."}
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="grid gap-4 md:grid-cols-2">
                            {bySubsector.map((item) => (
                                ...
                                >
                                    ...
                                    >
                                        {growthIcon(item.export_growth_percent)}
                                        {formatPercent(
                                            item.export_growth_percent,
                                        )}{" "}
                    ...
                    <section className="mb-8">
                        <div className="mb-4">
                            ...
                            <p className="mt-1 text-sm text-slate-500">
                                {isEn
                                    ? "Key movements from the current Specialty Textile trade snapshot."
                                    : "Pergerakan utama dari snapshot perdagangan Specialty Textile saat ini."}
                            </p>
                        </div>
                        ...
                        <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-4">
                            ...
                            <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                                ...
                                <div className="mt-1 text-xs text-slate-400">
                                    {isEn
                                        ? "Largest Specialty Textile import origin"
                                        : "Negara asal impor Specialty Textile terbesar"}
                                </div>
                            </div>
                            ...
                            <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                                ...
                                <div className="mt-1 text-xs text-slate-400">
                                    {isEn
                                        ? "Largest Specialty Textile export destination"
                                        : "Negara tujuan ekspor Specialty Textile terbesar"}
                                </div>
                            </div>
                        </div>
                    </section>
                        ...
                        <div className="border-b border-slate-100 px-6 py-5">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-slate-500">
                                        {isEn
                                            ? "Detailed Specialty Textile products by HS-8."
                                            : "Detail produk Specialty Textile pada tingkat HS-8."}
                                    </p>
                                </div>
                            </div>
                        </div>
