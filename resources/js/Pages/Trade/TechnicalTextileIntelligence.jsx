...
export default function TechnicalTextileIntelligence({
    technicalTextile = {},
    page = {},
}) {
    const { props } = usePage();
    ...
    */
    ...
    const meta = technicalTextile?.meta ?? {};
    ...
    const overview = technicalTextile?.overview ?? {
        import: {
            current: 0,
            previous: 0,
            growth_percent: 0,
    ...
    const bySubsector = technicalTextile?.by_subsector ?? [];

    const topImportProducts = technicalTextile?.top_import_products ?? [];

    const topExportProducts = technicalTextile?.top_export_products ?? [];

    const topImportOrigins = technicalTextile?.top_import_origins ?? [];

    const topExportDestinations =
        technicalTextile?.top_export_destinations ?? [];

    const importMarketShare = technicalTextile?.import_market_share ?? [];

    const exportMarketShare = technicalTextile?.export_market_share ?? [];

    const monthlyTrend = technicalTextile?.monthly_trend ?? [];

    const hs8Products = technicalTextile?.hs8_products ?? [];
    ...
    */
    ...
    const labels = {
        title: "Technical / Industrial Textile Intelligence",

        subtitle: isEn
            ? "Technical / Industrial Textile Trade Intelligence"
            : "Trade Intelligence Tekstil Teknis / Industri",
    ...
    */
    ...
    const subsectorAccent = (subsector) => {
        switch (subsector) {
            case "nonwoven_felt":
                return {
            ...
            case "industrial_reinforcement_fabric":
                return {
                    badge: "bg-sky-50 text-sky-700",
                    bar: "bg-sky-500",
                };

            case "coated_laminated_fabric":
                return {
                    badge: "bg-amber-50 text-amber-700",
                    bar: "bg-amber-500",
                };

            case "industrial_yarn_cord":
                return {
                    badge: "bg-violet-50 text-violet-700",
                    bar: "bg-violet-500",
                };

            case "technical_textile_articles":
                return {
                ...
                <main className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
                    ...
                    <section className="mb-8">
                        <div className="mb-4">
                            ...
                            <p className="mt-1 text-sm text-slate-500">
                                {isEn
                                    ? "Current Technical / Industrial Textile trade position and year-on-year movement."
                                    : "Posisi perdagangan Technical / Industrial Textile saat ini dan pergerakan year-on-year."}
                            </p>
                        </div>
                    ...
                    <section className="mb-8">
                        <div className="mb-4 flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-slate-500">
                                    {isEn
                                        ? "Technical / Industrial Textile market by product segment."
                                        : "Struktur pasar Technical / Industrial Textile berdasarkan segmen produk."}
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                            {bySubsector.map((item) => {
                                const accent = subsectorAccent(item.subsector);
                                ...
                                return (
                                    ...
                                    >
                                        <div className="flex items-start justify-between gap-3">
                                            ...
                                            <span
                                                className={`shrink-0 rounded-full px-2.5 py-1 text-[9px] font-black uppercase tracking-wider ${accent.badge}`}
                                            >
                                                Technical
                                            </span>
                                        </div>
                    ...
                    <section className="mb-8">
                        <div className="mb-4">
                            ...
                            <p className="mt-1 text-sm text-slate-500">
                                {isEn
                                    ? "Key movements from the current Technical / Industrial Textile trade snapshot."
                                    : "Pergerakan utama dari snapshot perdagangan Technical / Industrial Textile saat ini."}
                            </p>
                        </div>
                        ...
                        <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-4">
                            ...
                            <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                                ...
                                <div className="mt-1 text-xs text-slate-400">
                                    {isEn
                                        ? "Largest Technical / Industrial Textile import origin"
                                        : "Negara asal impor Technical / Industrial Textile terbesar"}
                                </div>
                            </div>
                            ...
                            <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                                ...
                                <div className="mt-1 text-xs text-slate-400">
                                    {isEn
                                        ? "Largest Technical / Industrial Textile export destination"
                                        : "Negara tujuan ekspor Technical / Industrial Textile terbesar"}
                                </div>
                            </div>
                        </div>
                    </section>
                        ...
                        <div className="border-b border-slate-100 px-6 py-5">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-slate-500">
                                        {isEn
                                            ? "Detailed Technical / Industrial Textile products by HS-8."
                                            : "Detail produk Technical / Industrial Textile pada tingkat HS-8."}
                                    </p>
                                </div>
                            </div>
                        </div>
                                ...
                                <tbody className="divide-y divide-slate-100">
                                    {hs8Products.map((item) => (
                                        ...
                                        >
                                            ...
                                            <td className="min-w-[380px] px-6 py-4">
                                            ...
                                            <td className="whitespace-nowrap px-6 py-4">
                                                <span className="inline-flex rounded-full bg-slate-100 px-2.5 py-1 text-[10px] font-black uppercase tracking-wider text-slate-700">
                                                    {item.chapter}
                                                </span>
                                            </td>
