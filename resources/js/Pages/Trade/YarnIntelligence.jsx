...
export default function YarnIntelligence({ yarn = {}, page = {} }) {
    const { props } = usePage();
    ...
    */
    ...
    const bySubsector = yarn?.by_subsector ?? [];

    const topImportProducts = yarn?.top_import_products ?? [];

    const topExportProducts = yarn?.top_export_products ?? [];

    const topImportOrigins = yarn?.top_import_origins ?? [];

    const topExportDestinations = yarn?.top_export_destinations ?? [];

    const importMarketShare = yarn?.import_market_share ?? [];

    const exportMarketShare = yarn?.export_market_share ?? [];

    const monthlyTrend = yarn?.monthly_trend ?? [];

    const hs8Products = yarn?.hs8_products ?? [];
    ...
    */
    ...
    const labels = {
        title: isEn ? "Yarn Intelligence" : "Yarn Intelligence",

        subtitle: isEn
            ? "Yarn Trade Intelligence"
            : "Trade Intelligence Benang",
                ...
                <main className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
                    ...
                    <section className="mb-8">
                        <div className="mb-4">
                            ...
                            <p className="mt-1 text-sm text-slate-500">
                                {isEn
                                    ? "Current Yarn trade position and year-on-year movement."
                                    : "Posisi perdagangan Yarn saat ini dan pergerakan year-on-year."}
                            </p>
                        </div>
                        ...
                        <div className="mb-4 flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-slate-500">
                                    {isEn
                                        ? "Yarn market by product segment."
                                        : "Struktur pasar Yarn berdasarkan segmen produk."}
                                </p>
                            </div>
                        </div>
                    ...
                    <section className="mb-8">
                        <div className="mb-4">
                            ...
                            <p className="mt-1 text-sm text-slate-500">
                                {isEn
                                    ? "Key movements from the current Yarn trade snapshot."
                                    : "Pergerakan utama dari snapshot perdagangan Yarn saat ini."}
                            </p>
                        </div>
                        ...
                        <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-4">
                            ...
                            <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                                ...
                                <div className="mt-1 text-xs text-slate-400">
                                    {isEn
                                        ? "Largest Yarn import origin"
                                        : "Negara asal impor Yarn terbesar"}
                                </div>
                            </div>
                            ...
                            <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                                ...
                                <div className="mt-1 text-xs text-slate-400">
                                    {isEn
                                        ? "Largest Yarn export destination"
                                        : "Negara tujuan ekspor Yarn terbesar"}
                                </div>
                            </div>
                        </div>
                    </section>
                        ...
                        <div className="border-b border-slate-100 px-6 py-5">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-slate-500">
                                        {isEn
                                            ? "Detailed Yarn products by HS-8."
                                            : "Detail produk Yarn pada tingkat HS-8."}
                                    </p>
                                </div>
                            </div>
                        </div>
