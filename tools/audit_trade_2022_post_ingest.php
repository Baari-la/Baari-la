...
const EXPECTED_RECORDS = 159658;
const EXPECTED_PROVINCE_NULL = 1;

echo "========================================\n";
echo "DIGESTEX POST-INGEST AUDIT 2022\n";
echo "========================================\n\n";
...
/*
|--------------------------------------------------------------------------
| Expected aggregates from production baseline
|--------------------------------------------------------------------------
*/
