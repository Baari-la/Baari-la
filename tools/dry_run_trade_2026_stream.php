...
/*
|--------------------------------------------------------------------------
| DIGESTEX STREAMING TRADE DRY-RUN 2026
|--------------------------------------------------------------------------
|
| Source:
...
const OUTPUT_FILE =
    'C:\\Users\\user\\Desktop\\DIGESTEX_DATA\\PROCESSED\\dry_run_export_2026.csv';
...
echo "========================================\n";
echo "DIGESTEX STREAMING TRADE DRY-RUN 2026\n";
echo "========================================\n\n";
...
while ($reader->read()) {
    ...
    */
    ...
    |
    | IMPORTANT:
    |   Only MONTH_START..MONTH_END are processed.
    |   Therefore July-December cannot enter output.
    |
    */
...
echo "PERIOD:\n";
echo "  INCLUDED MONTHS       : 1-6\n";
echo "  EXCLUDED MONTHS       : 7-12\n";
