...
/*
|--------------------------------------------------------------------------
| DIGESTEX PRODUCTION TRADE INGESTION 2025
|--------------------------------------------------------------------------
|
| Canonical master:
|   mst_hscode
...
echo "========================================\n";
echo "DIGESTEX PRODUCTION TRADE INGESTION 2025\n";
echo "========================================\n\n";
...
try {
    ...
    */
    ...
    $batch =
        TradeImportBatch::create([
            ...
            'remarks' =>
                'Streaming production ingestion 2025.',
    ...
    */
    ...
    $batch->update([
        ...
        'remarks' =>
            sprintf(
                '2025 streaming ingestion completed. Source rows: %d, active source rows: %d, monthly records: %d, fully resolved: %d, partially resolved: %d, duration: %.2f seconds.',
                $totalSourceRows,
                $activeSourceRows,
                $monthlyRecords,
                $fullyResolved,
...
echo PHP_EOL;
echo "========================================\n";
echo "DIGESTEX TRADE INGESTION 2025 COMPLETE\n";
echo "========================================\n\n";
