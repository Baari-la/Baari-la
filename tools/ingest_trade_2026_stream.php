...
/*
|--------------------------------------------------------------------------
| DIGESTEX PRODUCTION TRADE INGESTION 2026
|--------------------------------------------------------------------------
|
| Canonical master:
|   mst_hscode
|
| Source:
|   Kemendag EXPORT 2026
|
| IMPORTANT:
|   2026 hanya JANUARI-JUNI.
|
| Mode:
|   WRITE
|
...
echo "========================================\n";
echo "DIGESTEX PRODUCTION TRADE INGESTION 2026\n";
echo "========================================\n\n";
...
try {
    ...
    */
    ...
    $batch =
        TradeImportBatch::create([
            ...
            'remarks' =>
                '2026 streaming production ingestion. January-June only.',
    ...
    */
    ...
    $batch->update([
        ...
        'remarks' =>
            sprintf(
                '2026 streaming ingestion completed. January-June only. Source rows: %d, active source rows: %d, monthly records: %d, fully resolved: %d, partially resolved: %d, duration: %.2f seconds.',
                $totalSourceRows,
                $activeSourceRows,
                $monthlyRecords,
                $fullyResolved,
...
echo PHP_EOL;
echo "========================================\n";
echo "DIGESTEX TRADE INGESTION 2026 COMPLETE\n";
echo "========================================\n\n";

echo "PERIOD                  : JANUARY-JUNE ONLY\n";
