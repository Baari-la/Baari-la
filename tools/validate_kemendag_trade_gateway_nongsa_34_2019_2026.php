...
echo "========================================\n";
echo "DIGESTEX KEMENDAG NONGSA GATEWAY VALIDATION\n";
echo "========================================\n\n";
...
echo "  CANDIDATE   : SEKUPANG PORT\n";
echo "  TRADE POINT : ID=34\n";
...
$masterPass =
    ...
    &&
    (string) $master->name === 'Sekupang Port'
    &&
...
if (!$masterPass) {
    throw new RuntimeException(
        'NONGSA candidate master validation failed.'
    );
}
...
if ($totalResidual !== $expectedRecords) {
    throw new RuntimeException(
        "Expected {$expectedRecords} NONGSA residual records, got {$totalResidual}."
    );
}
...
echo "  SOURCE + CANDIDATE ID=34 : {$directCandidateResolved}\n";
echo "  EXPECTED                 : 0\n\n";
...
echo "========================================\n";
echo "NONGSA TRADE GATEWAY VALIDATION : COMPLETE\n";
echo "========================================\n";