...
echo "========================================\n";
echo "DIGESTEX KEMENDAG PERAWANG TRADE GATEWAY VALIDATION\n";
echo "========================================\n\n";

echo "SCOPE:\n";
echo "  YEARS       : 2019-2026\n";
echo "  TRADE FLOWS : EXPORT + IMPORT\n";
echo "  SOURCE      : PERAWANG, SUMATRA\n";
echo "  SOURCE PROV : 29 - RIAU\n";
echo "  OPERATION   : READ ONLY\n\n";

$sourceName = 'PERAWANG, SUMATRA';
$sourceProvinceId = 29;
$expectedRecords = 848;

$candidateIds = [
    42, // Sungai Guntung Port
    53, // Kuala Enok Port
    56, // Tembilahan Port
];
...
if (!$masterPass) {
    throw new \RuntimeException(
        'One or more PERAWANG candidate masters failed validation.'
    );
}
...
if ($totalResidual !== $expectedRecords) {
    throw new \RuntimeException(
        "Expected {$expectedRecords} PERAWANG residual records, got {$totalResidual}."
    );
}
...
echo "========================================\n";
echo "PERAWANG TRADE GATEWAY VALIDATION : COMPLETE\n";
echo "========================================\n";