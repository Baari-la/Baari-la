...
echo "========================================\n";
echo "DIGESTEX KEMENDAG WEDA GATEWAY VALIDATION\n";
echo "========================================\n\n";
...
if (!$masterPass) {
    throw new \RuntimeException(
        'WEDA candidate master validation failed.'
    );
}
...
if ($totalResidual !== 535) {
    throw new \RuntimeException(
        "Expected 535 WEDA residual records, got {$totalResidual}."
    );
}
...
echo "========================================\n";
echo "WEDA TRADE GATEWAY VALIDATION : COMPLETE\n";
echo "========================================\n";